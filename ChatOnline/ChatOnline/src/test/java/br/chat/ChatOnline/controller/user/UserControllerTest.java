...
class UserControllerTest {
    ...
    void registerValidData() throws Exception {
        ...
        // Ajuste no nome do método para corresponder ao da classe de produção
        when(userService.hashPassword(password)).thenReturn(hashedPassword);
        ...
        // Verificação que o conteúdo retornado possui o nome de usuário esperado e senha original
        var jsonExpected = jsonRequest.write(new AuthenticationDTO(authenticationDTO.userName(), password)).getJson();
